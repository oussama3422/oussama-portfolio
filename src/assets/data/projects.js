...
// Dynamically import images for better performance
const importImage = (imageName) => require(`../images/${imageName}`);

// Initial loading state
const LoadingMessage = () => <h2 style={{ color: "white" }}>Loading Projects...</h2>;

// Project data (moved to state for lazy loading)
const fetchProjects = () =>
  Promise.resolve([
    {
      name: "GetDPizza",
      ...
      githubLink: "https://github.com/oussama3422/GetDPizza",
      description:
        "PizzaPortal allows users to order pizza online. Built using React, Redux Toolkit, and Tailwind CSS.",
      websiteLink: "https://get-d-pizza.vercel.app/",
      toolsAndTechnologies: [
        "React",
        "React Router",
    ...
    },
    {
      ...
      categories: "Full Stack Development",
      githubLink: "https://github.com/oussama3422/Book-welt",
      description: "An admin dashboard for booking data management with charts.",
      websiteLink: "https://bookwelt.vercel.app/",
      toolsAndTechnologies: ["React", "Styled Components", "Recharts"],
      image: "book_welt.png",
    },
    ...
    },
    {
      ...
      categories: "Mobile Development (Front End)",
      githubLink: "",
      description: "A car repair app under development.",
      websiteLink: "Coming soon",
      toolsAndTechnologies: ["Flutter", "Dart", "Bloc", "Firebase"],
      image: "repair-car.png",
    },
  ]);